...
class BlockingRegistrationClientDiffblueTest {
  @Autowired private BlockingRegistrationClient blockingRegistrationClient;
   ...
   *
   * <p>Method under test: {@link BlockingRegistrationClient#deregister(String, String)}
   */
  @Test
  @DisplayName("Test deregister(String, String)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void BlockingRegistrationClient.deregister(String, String)"})
   ...
   *
   * <p>Method under test: {@link BlockingRegistrationClient#createRequestHeaders()}
   */
  @Test
  @DisplayName("Test createRequestHeaders()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"HttpHeaders BlockingRegistrationClient.createRequestHeaders()"})
  void testCreateRequestHeaders() {
    // Arrange and Act
    HttpHeaders actualCreateRequestHeadersResult =
        blockingRegistrationClient.createRequestHeaders();
