...
class RestClientRegistrationClientDiffblueTest {
  ...
  /**
   * Test {@link RestClientRegistrationClient#deregister(String, String)}.
   * <p>
   * Method under test: {@link RestClientRegistrationClient#deregister(String, String)}
   */
  @Test
  @DisplayName("Test deregister(String, String)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void RestClientRegistrationClient.deregister(String, String)"})
  void testDeregister() {
    // Arrange
    ResponseSpec responseSpec = mock(ResponseSpec.class);
    ...
    RequestBodySpec requestBodySpec = mock(RequestBodySpec.class);
    when(requestBodySpec.retrieve()).thenReturn(responseSpec);
    RequestHeadersUriSpec<RequestBodySpec> requestHeadersUriSpec = mock(RequestHeadersUriSpec.class);
    when(requestHeadersUriSpec.uri(Mockito.<String>any(), isA(Object[].class))).thenReturn(requestBodySpec);
    Mockito.<RequestHeadersUriSpec<?>>when(restClient.delete()).thenReturn(requestHeadersUriSpec);
