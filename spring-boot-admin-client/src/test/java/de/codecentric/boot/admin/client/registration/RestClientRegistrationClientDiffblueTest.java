...
class RestClientRegistrationClientDiffblueTest {
  ...
  @Autowired private RestClientRegistrationClient restClientRegistrationClient;

  /**
   * Test {@link RestClientRegistrationClient#register(String, Application)}.
   *
   * <ul>
   *   <li>Given {@link HashMap#HashMap()} {@code id} is {@code Value}.
   *   <li>Then return {@code Value}.
   * </ul>
   *
   * <p>Method under test: {@link RestClientRegistrationClient#register(String, Application)}
   */
  @Test
  @DisplayName(
      "Test register(String, Application); given HashMap() 'id' is 'Value'; then return 'Value'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"String RestClientRegistrationClient.register(String, Application)"})
  void testRegister_givenHashMapIdIsValue_thenReturnValue() {
    // Arrange
    ...
    when(requestBodySpec3.headers(Mockito.<Consumer<HttpHeaders>>any()))
        .thenReturn(requestBodySpec2);

    RequestBodyUriSpec requestBodyUriSpec = mock(RequestBodyUriSpec.class);
    when(requestBodyUriSpec.uri(Mockito.<String>any(), isA(Object[].class)))
    ...
    String actualRegisterResult =
        restClientRegistrationClient.register("https://example.org/example", application);
    ...
    assertEquals("Value", actualRegisterResult);
  }

  /**
   * Test {@link RestClientRegistrationClient#setRequestHeaders(HttpHeaders)}.
   *
   * <p>Method under test: {@link RestClientRegistrationClient#setRequestHeaders(HttpHeaders)}
   */
  @Test
  @DisplayName("Test setRequestHeaders(HttpHeaders)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void RestClientRegistrationClient.setRequestHeaders(HttpHeaders)"})
