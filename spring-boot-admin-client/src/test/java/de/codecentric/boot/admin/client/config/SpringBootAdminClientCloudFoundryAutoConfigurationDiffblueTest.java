...
class SpringBootAdminClientCloudFoundryAutoConfigurationDiffblueTest {
  /**
   * Test {@link
   * SpringBootAdminClientCloudFoundryAutoConfiguration#cloudFoundryMetadataContributor(CloudFoundryApplicationProperties)}.
   *
  ...
  void testCloudFoundryMetadataContributor() {
    ...
    SpringBootAdminClientCloudFoundryAutoConfiguration
        springBootAdminClientCloudFoundryAutoConfiguration =
            new SpringBootAdminClientCloudFoundryAutoConfiguration();
