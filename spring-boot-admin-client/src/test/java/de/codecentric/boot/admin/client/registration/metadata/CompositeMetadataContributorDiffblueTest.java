...
class CompositeMetadataContributorDiffblueTest {
   ...
   *
   * <p>Method under test: {@link CompositeMetadataContributor#CompositeMetadataContributor(List)}
   */
  @Test
  @DisplayName("Test new CompositeMetadataContributor(List)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void CompositeMetadataContributor.<init>(List)"})
   ...
   *
   * <p>Method under test: {@link CompositeMetadataContributor#getMetadata()}
   */
  @Test
  @DisplayName("Test getMetadata()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Map CompositeMetadataContributor.getMetadata()"})
   ...
   *
   * <ul>
   *   <li>Then calls {@link MetadataContributor#getMetadata()}.
   * </ul>
   *
   * <p>Method under test: {@link CompositeMetadataContributor#getMetadata()}
   */
