...
@ContextConfiguration(
    classes = {CloudFoundryMetadataContributor.class, CloudFoundryApplicationProperties.class})
@ExtendWith(SpringExtension.class)
class CloudFoundryMetadataContributorDiffblueTest {
  @Autowired private CloudFoundryApplicationProperties cloudFoundryApplicationProperties;

  @Autowired private CloudFoundryMetadataContributor cloudFoundryMetadataContributor;

  /**
   * Test {@link
   * CloudFoundryMetadataContributor#CloudFoundryMetadataContributor(CloudFoundryApplicationProperties)}.
   *
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void CloudFoundryMetadataContributor.<init>(CloudFoundryApplicationProperties)"
  })
  void testNewCloudFoundryMetadataContributor() {
    ...
    Map<String, String> metadata =
        new CloudFoundryMetadataContributor(cfApplicationProperties).getMetadata();
   ...
   *
   * <ul>
   *   <li>Given {@link CloudFoundryApplicationProperties} (default constructor) ApplicationId is
   *       {@code not blank}.
   * </ul>
   *
   * <p>Method under test: {@link CloudFoundryMetadataContributor#getMetadata()}
   */
  @Test
  @DisplayName(
      "Test getMetadata(); given CloudFoundryApplicationProperties (default constructor) ApplicationId is 'not blank'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  ...
  void testGetMetadata_givenCloudFoundryApplicationPropertiesApplicationIdIsNotBlank() {
    ...
    cfApplicationProperties.setInstanceIndex(" ");

    // Act and Assert
    assertTrue(
        new CloudFoundryMetadataContributor(cfApplicationProperties).getMetadata().isEmpty());
  }
   ...
   *
   * <ul>
   *   <li>Given {@link CloudFoundryMetadataContributor}.
