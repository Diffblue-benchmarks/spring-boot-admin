...
class SpringBootAdminEurekaApplicationDiffblueTest {
  ...
  @InjectMocks
  private SpringBootAdminEurekaApplication springBootAdminEurekaApplication;

  /**
   * Test {@link SpringBootAdminEurekaApplication#securityWebFilterChainPermitAll(ServerHttpSecurity)}.
   * <ul>
   *   <li>Then return {@link MatcherSecurityWebFilterChain}.</li>
   * </ul>
   * <p>
   * Method under test: {@link SpringBootAdminEurekaApplication#securityWebFilterChainPermitAll(ServerHttpSecurity)}
   */
  @Test
