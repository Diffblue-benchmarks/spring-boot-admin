...
class CustomCsrfFilterDiffblueTest {
  /**
   * Test {@link CustomCsrfFilter#doFilterInternal(HttpServletRequest, HttpServletResponse, FilterChain)}.
   * <ul>
   *   <li>Then throw {@link ServletException}.</li>
   * </ul>
   * <p>
   * Method under test: {@link CustomCsrfFilter#doFilterInternal(HttpServletRequest, HttpServletResponse, FilterChain)}
   */
  @Test
  @DisplayName("Test doFilterInternal(HttpServletRequest, HttpServletResponse, FilterChain); then throw ServletException")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void CustomCsrfFilter.doFilterInternal(HttpServletRequest, HttpServletResponse, FilterChain)"})
  void testDoFilterInternal_thenThrowServletException() throws ServletException, IOException {
    ...
    // Act and Assert
    assertThrows(ServletException.class, () -> customCsrfFilter.doFilterInternal(request, response, filterChain));
