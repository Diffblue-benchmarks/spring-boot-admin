...
class CustomEndpointDiffblueTest {
  @Autowired private CustomEndpoint customEndpoint;

  /**
   * Test {@link CustomEndpoint#invoke()}.
   *
   * <p>Method under test: {@link CustomEndpoint#invoke()}
   */
  @Test
   ...
   *
   * <p>Method under test: default or parameterless constructor of {@link CustomEndpoint}
   */
  @Test
