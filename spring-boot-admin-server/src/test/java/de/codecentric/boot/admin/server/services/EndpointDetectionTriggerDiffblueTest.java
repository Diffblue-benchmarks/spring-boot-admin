...
public class EndpointDetectionTriggerDiffblueTest {
   ...
   *   <li>When {@link Flux} {@link Flux#filter(Predicate)} return fromIterable {@link ArrayList#ArrayList()}.</li>
   * </ul>
   * <p>
  ...
  public void testHandle_givenFromIterableArrayList_whenFluxFilterReturnFromIterableArrayList() {
    // Arrange
