...
public class LegacyEndpointConvertersDiffblueTest {
  ...
  public void testHealth() throws AssertionError {
    ...
    StepVerifier.FirstStep<DataBuffer> createResult = StepVerifier.create(actualHealthResult.convert(null));
  ...
  public void testEnv() throws AssertionError {
    ...
    StepVerifier.FirstStep<DataBuffer> createResult = StepVerifier.create(actualEnvResult.convert(null));
    createResult.expectError().verify();
  }
  ...
  public void testHttptrace() throws AssertionError {
    ...
    StepVerifier.FirstStep<DataBuffer> createResult = StepVerifier.create(actualHttptraceResult.convert(null));
    createResult.expectError().verify();
  }
  ...
  public void testThreaddump() throws AssertionError {
    ...
    StepVerifier.FirstStep<DataBuffer> createResult = StepVerifier.create(actualThreaddumpResult.convert(null));
    createResult.expectError().verify();
  }
  ...
  public void testLiquibase() throws AssertionError {
    ...
    StepVerifier.FirstStep<DataBuffer> createResult = StepVerifier.create(actualLiquibaseResult.convert(null));
    createResult.expectError().verify();
  }
  ...
  public void testFlyway() throws AssertionError {
    ...
    StepVerifier.FirstStep<DataBuffer> createResult = StepVerifier.create(actualFlywayResult.convert(null));
    createResult.expectError().verify();
  }
  ...
  public void testBeans() throws AssertionError {
    ...
    StepVerifier.FirstStep<DataBuffer> createResult = StepVerifier.create(actualBeansResult.convert(null));
    createResult.expectError().verify();
  }
  ...
  public void testConfigprops() throws AssertionError {
    ...
    StepVerifier.FirstStep<DataBuffer> createResult = StepVerifier.create(actualConfigpropsResult.convert(null));
    createResult.expectError().verify();
  }
  ...
  public void testMappings() throws AssertionError {
    ...
    StepVerifier.FirstStep<DataBuffer> createResult = StepVerifier.create(actualMappingsResult.convert(null));
    createResult.expectError().verify();
  }
