...
public class AdminServerAutoConfigurationDiffblueTest {
  ...
  public void testInstanceIdGenerator() {
    // Arrange, Act and Assert
    assertTrue(adminServerAutoConfiguration.instanceIdGenerator() instanceof HashingInstanceUrlIdGenerator);
  }
  ...
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
      "StatusUpdater AdminServerAutoConfiguration.statusUpdater(InstanceRepository, InstanceWebClient.Builder)"})
  ...
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
      "EndpointDetector AdminServerAutoConfiguration.endpointDetector(InstanceRepository, InstanceWebClient.Builder)"})
  ...
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
      "de.codecentric.boot.admin.server.services.EndpointDetectionTrigger AdminServerAutoConfiguration.endpointDetectionTrigger(EndpointDetector, Publisher)"})
  ...
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
      "InfoUpdater AdminServerAutoConfiguration.infoUpdater(InstanceRepository, InstanceWebClient.Builder)"})
