...
public class DiscordNotifierDiffblueTest {
  ...
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"reactor.core.publisher.Mono DiscordNotifier.doNotify(InstanceEvent, Instance)"})
  ...
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"String DiscordNotifier.getAvatarUrl()", "String DiscordNotifier.getUsername()",
      "URI DiscordNotifier.getWebhookUrl()", "boolean DiscordNotifier.isTts()",
      "void DiscordNotifier.setAvatarUrl(String)", "void DiscordNotifier.setRestTemplate(RestTemplate)",
      "void DiscordNotifier.setTts(boolean)", "void DiscordNotifier.setUsername(String)",
