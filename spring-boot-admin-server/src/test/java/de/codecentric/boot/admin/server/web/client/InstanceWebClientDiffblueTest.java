...
public class InstanceWebClientDiffblueTest {
  ...
  @MethodsUnderTest({"InstanceWebClient.Builder InstanceWebClient.Builder.filter(InstanceExchangeFilterFunction)"})
  ...
  public void testInstanceWithInstance2() {
    ...
    InstanceWebClient buildResult = InstanceWebClient.builder().webClient(builder2).build();

    // Act and Assert
    assertThrows(ResolveInstanceException.class, () -> buildResult.instance((Instance) null));
    verify(webClient).mutate();
  ...
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"WebClient InstanceWebClient.instance(Instance)"})
  public void testInstanceWithInstance_givenBuilderBuildReturnWebClient() {
    // Arrange
    Builder builder = mock(Builder.class);
  ...
  public void testInstanceWithMono2() {
    ...
    when(builder4.filters(Mockito.<Consumer<List<ExchangeFilterFunction>>>any())).thenReturn(builder3);
    WebClient webClient3 = mock(WebClient.class);
    when(webClient3.mutate()).thenReturn(builder4);
    Builder builder5 = mock(Builder.class);
    when(builder5.build()).thenReturn(webClient3);
    InstanceWebClient buildResult = builder2.webClient(builder5).build();
  ...
  public void testInstanceWithMono_thenCallsBuild() {
    ...
    when(webClient2.mutate()).thenReturn(mock(Builder.class));
    Builder builder4 = mock(Builder.class);
    when(builder4.build()).thenReturn(webClient2);
    InstanceWebClient buildResult2 = builder3.webClient(builder4).build();
