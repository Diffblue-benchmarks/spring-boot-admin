...
class NotificationTriggerDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test sendNotifications(InstanceEvent); given ConcurrentHashMap() InstanceId with value is '42' is forty-two")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Mono NotificationTrigger.sendNotifications(InstanceEvent)"})
  void testSendNotifications_givenConcurrentHashMapInstanceIdWithValueIs42IsFortyTwo()
      throws AssertionError {
    // Arrange
    ConcurrentHashMap<InstanceId, Long> sentNotifications = new ConcurrentHashMap<>();
    sentNotifications.put(InstanceId.of("42"), 42L);
