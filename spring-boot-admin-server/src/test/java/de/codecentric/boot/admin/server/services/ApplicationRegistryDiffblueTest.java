...
public class ApplicationRegistryDiffblueTest {
  ...
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"Flux ApplicationRegistry.getApplications()"})
  public void testGetApplications_givenFluxGroupByReturnFromIterableArrayList_thenCallsGroupBy() throws AssertionError {
    // Arrange
    Flux<Instance> flux = mock(Flux.class);
  ...
  public void testGetApplication_givenFluxCollectListReturnJustArrayList_thenCallsCollectList() throws AssertionError {
    // Arrange
    Flux<Instance> flux = mock(Flux.class);
  ...
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"Mono ApplicationRegistry.getApplication(String)"})
  public void testGetApplication_givenFluxFilterReturnFromIterableArrayList_thenCallsFilter() throws AssertionError {
    // Arrange
    Flux<Instance> flux = mock(Flux.class);
    Flux<Instance> fromIterableResult = Flux.fromIterable(new ArrayList<>());
    when(flux.filter(Mockito.<Predicate<Instance>>any())).thenReturn(fromIterableResult);
  ...
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"Mono ApplicationRegistry.getApplication(String)"})
  public void testGetApplication_givenInstanceRegistryGetInstancesReturnFromIterableArrayList() throws AssertionError {
    // Arrange
    Flux<Instance> fromIterableResult = Flux.fromIterable(new ArrayList<>());
  ...
  public void testDeregister_givenFluxFlatMapReturnFromIterableArrayList_thenCallsFlatMap() throws AssertionError {
    // Arrange
    Flux<Instance> flux = mock(Flux.class);
    Flux<Object> fromIterableResult = Flux.fromIterable(new ArrayList<>());
  ...
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
      "de.codecentric.boot.admin.server.domain.values.BuildVersion ApplicationRegistry.getBuildVersion(List)"})
  ...
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"reactor.util.function.Tuple2 ApplicationRegistry.getStatus(List)"})
