...
public class PagerdutyNotifierDiffblueTest {
  ...
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"reactor.core.publisher.Mono PagerdutyNotifier.doNotify(InstanceEvent, Instance)"})
  ...
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"String PagerdutyNotifier.getClient()", "URI PagerdutyNotifier.getClientUrl()",
      "String PagerdutyNotifier.getServiceKey()", "URI PagerdutyNotifier.getUrl()",
      "void PagerdutyNotifier.setClient(String)", "void PagerdutyNotifier.setClientUrl(URI)",
      "void PagerdutyNotifier.setRestTemplate(RestTemplate)", "void PagerdutyNotifier.setServiceKey(String)",
