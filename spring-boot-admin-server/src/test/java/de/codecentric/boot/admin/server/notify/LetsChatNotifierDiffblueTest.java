...
public class LetsChatNotifierDiffblueTest {
  ...
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"reactor.core.publisher.Mono LetsChatNotifier.doNotify(InstanceEvent, Instance)"})
  ...
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"String LetsChatNotifier.getRoom()", "String LetsChatNotifier.getToken()",
      "URI LetsChatNotifier.getUrl()", "String LetsChatNotifier.getUsername()",
      "void LetsChatNotifier.setRestTemplate(RestTemplate)", "void LetsChatNotifier.setRoom(String)",
      "void LetsChatNotifier.setToken(String)", "void LetsChatNotifier.setUrl(URI)",
