...
public class TelegramNotifierDiffblueTest {
  ...
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"reactor.core.publisher.Mono TelegramNotifier.doNotify(InstanceEvent, Instance)"})
  ...
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"String TelegramNotifier.getApiUrl()", "String TelegramNotifier.getAuthToken()",
      "String TelegramNotifier.getChatId()", "String TelegramNotifier.getParseMode()",
      "boolean TelegramNotifier.isDisableNotify()", "void TelegramNotifier.setApiUrl(String)",
      "void TelegramNotifier.setAuthToken(String)", "void TelegramNotifier.setChatId(String)",
      "void TelegramNotifier.setDisableNotify(boolean)", "void TelegramNotifier.setParseMode(String)",
