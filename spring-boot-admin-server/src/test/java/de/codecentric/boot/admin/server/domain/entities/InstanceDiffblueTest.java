...
public class InstanceDiffblueTest {
  ...
  /**
   * Test {@link Instance#equals(Object)}.
   * <ul>
  ...
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"boolean Instance.equals(Object)", "int Instance.hashCode()"})
  ...
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"BuildVersion Instance.getBuildVersion()", "Endpoints Instance.getEndpoints()",
      "InstanceId Instance.getId()", "Info Instance.getInfo()", "StatusInfo Instance.getStatusInfo()",
      "Instant Instance.getStatusTimestamp()", "Tags Instance.getTags()", "long Instance.getVersion()",
      "boolean Instance.isRegistered()", "String Instance.toString()"})
