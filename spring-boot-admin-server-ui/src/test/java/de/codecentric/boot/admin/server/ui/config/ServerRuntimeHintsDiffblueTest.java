...
class ServerRuntimeHintsDiffblueTest {
  @Autowired private ServerRuntimeHints serverRuntimeHints;

  /**
   * Test {@link ServerRuntimeHints#registerHints(RuntimeHints, ClassLoader)}.
   *
   * <p>Method under test: {@link ServerRuntimeHints#registerHints(RuntimeHints, ClassLoader)}
   */
  @Test
  @DisplayName("Test registerHints(RuntimeHints, ClassLoader)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void ServerRuntimeHints.registerHints(RuntimeHints, ClassLoader)"})
