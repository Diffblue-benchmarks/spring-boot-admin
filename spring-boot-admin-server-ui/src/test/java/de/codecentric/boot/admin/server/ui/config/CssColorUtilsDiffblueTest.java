...
class CssColorUtilsDiffblueTest {
  @Autowired private CssColorUtils cssColorUtils;
   ...
   * <ul>
   *   <li>When {@code #999999}.
   *   <li>Then return {@code 153, 153, 153}.
   * </ul>
   *
   * <p>Method under test: {@link CssColorUtils#hexToRgb(String)}
   */
  @Test
  @DisplayName("Test hexToRgb(String); when '#999999'; then return '153, 153, 153'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"String CssColorUtils.hexToRgb(String)"})
  ...
  @Test
  @DisplayName(
      "Test hexToRgb(String); when '0123456789ABCDEF'; then throw IllegalArgumentException")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"String CssColorUtils.hexToRgb(String)"})
